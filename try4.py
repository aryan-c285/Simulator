...
# Initialize all registers to 0, including r1 and r10
REGISTER_STATE = {f"r{i}": "0" for i in range(32)}
# Only r2 is initialized to 380 as per your requirements
...
def reset_registers():
    ...
    REGISTER_STATE = {f"r{i}": "0" for i in range(32)}
    REGISTER_STATE["r2"] = "380"  # Only r2 is initialized to 380 after reset
